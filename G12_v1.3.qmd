...
#Import the data
Advertisements <- readr::read_csv("less_than_1000/Advertisements.csv")
Customers <- readr::read_csv("less_than_1000/Customers.csv")
Order_items <- readr::read_csv("less_than_1000/Order_items.csv")
Orders <- readr::read_csv("less_than_1000/Orders.csv")
Payments <- readr::read_csv("less_than_1000/Payments.csv")
Products <- readr::read_csv("less_than_1000/Products.csv")
Shipments <- readr::read_csv("less_than_1000/Shipments.csv")
Suppliers <- readr::read_csv("less_than_1000/Suppliers.csv")
```
...
all_files <- list.files("less_than_1000/")

for (variable in all_files) {
  this_filepath <- paste0("less_than_1000/",variable)
